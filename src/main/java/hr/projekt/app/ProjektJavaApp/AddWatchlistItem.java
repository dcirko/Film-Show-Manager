...
public class AddWatchlistItem {
    ...
    public void addMovieToWatchlist(){
        ...
        if(containsWatchlistItem(watchlistItems, watchlistItem) && movieString != null){
            ...
            ChangesUtils.logChange("New Movie Added To Watchlist", " ", watchlistItem.getName(), user.getUsername());
    ...
    public void addSeriesToWatchlist(){
        ...
        if(containsWatchlistItem(watchlistItems, watchlistItem) && seriesString != null){
            ...
            UserPair<String, String> user = UserUtils.getLoggedInUser();
            ChangesUtils.logChange("New Series Added To Watchlist", " ", watchlistItem.getName(), user.getUsername());
